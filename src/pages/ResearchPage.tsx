            ...
            <ExpandableCard key={lit.id} title={`${lit.authors.split(',')[0].split(' ').pop()} (${lit.year}) — ${lit.title.substring(0, 80)}…`}>
              <div className="space-y-3 mt-3">
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  ...
                  {lit.pubmed && (
                    <a href={lit.pubmed} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-xs bg-green-50 text-green-700 px-3 py-1.5 rounded-full hover:bg-green-100 transition-colors">
